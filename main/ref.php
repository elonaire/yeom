				...
				<div class="col-6">
					...
					<?php
						...
						while ($row = $result->fetch_assoc()) {
							echo "<li class='list-item'>".$row['name']."............................$".$row['price']."<form method='POST' action='".Food($dbc)."'><input type='hidden' name='fid' value='".$row['fid']."'><input type='hidden' name='sid' value='".$sess."'><input type='hidden' name='bal' value='".$bal."'><button type='submit' class='comment' name='commFood'>Comment</button><button type='submit' class='buy' name='buyFood'>Buy</button></form></li>";
						}
						echo "</ul>";
					?>
				</div>
